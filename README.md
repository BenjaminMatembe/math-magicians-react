...
<div align="center">
  ...
  <h3><b>Benjamin's Math_magicians README</b></h3>
...
Clone the code from project using terminal into your local machine and `npm install` to install node modules, then `npm start` to run the project in your browser.
...
>Clone this repository to your desired folder using:
 ...
 git clone git@github.com:BenjaminMatembe/math-magicians-react.git

 <h1>Using HTTPS</h1>

 git clone https://github.com/BenjaminMatembe/math-magicians-react.git
...
>npm start and the project will start at localhost 3000
...
<ul>
    <li>Connect to frameworks and Database</li>
  </ul>
